...
import Firebase from './Utilities/Utilities_Firebase';
import { useAuthState } from "react-firebase-hooks/auth";
import {auth, db, database} from "./Utilities/Utilities_Firebase";
import {collection, onSnapshot} from "firebase/firestore";
import Decoration from "./Decorations/Decoration";
import Utilities_Pagination from "./Utilities/Utilities_Pagination"

export default function Home_Organizations(){
            ...
            <div className="organizations_container">
                ...
                {name === "foundations" ?
                    ...
                    {currentFoundations.map((foundation) =>
                        ...
                        <Utilities_Pagination recordsPerPage={recordsPerPage}
